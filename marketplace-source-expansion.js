...
export const MARKETPLACE_SOURCE_EXPANSION=Object.freeze({
  ...
  TRENDYOL_MARKETPLACE_SELLER_API:{platform:'TRENDYOL',role:'LOCAL_MARKET_SELLER_DATA',signalRole:'ROMANIA_SELLER',access:'OFFICIAL_API_V2',status:'READY_WITH_CREDENTIALS',rankingEvidence:false,catalogueDiscovery:true,demandEvidence:false,supplyEvidence:false,marketWideEvidence:false,sellerScoped:true,storeScoped:false,credentialsRequired:true,credentialEnv:['TRENDYOL_SELLER_ID','TRENDYOL_API_KEY','TRENDYOL_API_SECRET'],paid:false,autoExecute:false},
  TRENDYOL_PUBLIC_MARKET:{platform:'TRENDYOL',role:'ROMANIA_PUBLIC_MARKET_SIGNAL',signalRole:'ROMANIA_MARKET',access:'REVIEWED_PUBLIC_PAGE',status:'REVIEW_REQUIRED',rankingEvidence:false,catalogueDiscovery:true,demandEvidence:true,supplyEvidence:false,marketWideEvidence:true,sellerScoped:false,storeScoped:false,credentialsRequired:false,paid:false,autoExecute:false},
  SHEIN_MARKETPLACE_SELLER_API:{platform:'SHEIN',role:'MARKETPLACE_SELLER_DATA',signalRole:'SELLER_ACCOUNT',access:'OFFICIAL_OPEN_PLATFORM',status:'READY_WITH_AUTHORIZATION',rankingEvidence:false,catalogueDiscovery:true,demandEvidence:false,supplyEvidence:false,marketWideEvidence:false,sellerScoped:true,storeScoped:false,credentialsRequired:true,credentialEnv:['SHEIN_APP_ID','SHEIN_APP_SECRET','SHEIN_SELLER_AUTH_TOKEN'],paid:false,autoExecute:false},
  SHEIN_PUBLIC_MARKET:{platform:'SHEIN',role:'PUBLIC_MARKET_SIGNAL',signalRole:'MARKET_SIGNAL',access:'REVIEWED_PUBLIC_PAGE',status:'REVIEW_REQUIRED',rankingEvidence:false,catalogueDiscovery:true,demandEvidence:true,supplyEvidence:false,marketWideEvidence:true,sellerScoped:false,storeScoped:false,credentialsRequired:false,paid:false,autoExecute:false},
