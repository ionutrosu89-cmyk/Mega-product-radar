...
Please quote the exact magnetic car sun-visor sunglasses holder shown in your listing and confirm:

1. Main material: PU leather / genuine leather / ABS / other.
2. Internal structure and magnet type/quantity.
3. Product dimensions and net weight.
4. Compatible sun-visor thickness range.
5. Maximum glasses/frame thickness supported.
6. Whether the holder includes a card/ticket slot.
7. Whether contact surfaces include anti-scratch / protective material.
8. Available colors and finish.
9. Magnet holding strength or relevant internal quality specification.
10. Individual packaging type and dimensions.
11. Quantity per export carton, carton gross weight and carton dimensions.
12. Exact supplier SKU/model for the quoted item.
...
13. Payment terms and whether Trade Assurance or equivalent order protection is available.
14. Whether third-party or agent inspection is accepted before shipment.
15. Quote date and quote validity period.
16. Direct product URL and exact SKU/model reference for the quoted item.
