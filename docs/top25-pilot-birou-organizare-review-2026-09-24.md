...
### Mapare Amazon.com propusă la 26 septembrie

Pagina Amazon.com [Desk Accessories & Workspace Organizers](https://www.amazon.com/gp/bestsellers/office-products/1069514) identifică nodul `1069514`, iar subcategoria [Drawer Organizers](https://www.amazon.com/gp/bestsellers/office-products/1069540) identifică nodul `1069540`. Am deschis direct prima pagină a clasamentului pentru `1069514`; lista conținea atât organizatoare, cât și mouse paduri, bandă adezivă, suporturi ergonomice și alte rezultate excluse de taxonomia MPR. Pagina 1 expunea rangurile 1–30, iar pagina 2 începea la rangul 51 și termina la 80: rangurile 31–50 nu erau vizibile în această rută publică. Aceste pagini nu pot produce un Top 100 continuu pentru ingestie. Această constatare justifică o sursă licențiată cu acoperire completă, un bazin de candidați mai mare decât 25 și revizie per produs. `1069540` este prea îngustă pentru a reprezenta singură nișa completă. Ambele noduri rămân **propuse, neaprobate** în `data/top25-niche-review-v1.json`; accesul și drepturile de afișare nu decurg din vizualizarea paginii publice. Colectorul Keepa curent acceptă o singură categorie per nișă, așadar pentru pilot se validează mai întâi cât de multe concepte eligibile produce categoria părinte. Dacă nu ajunge la 25, se va extinde mecanismul la mai multe subcategorii cu deduplicare și plafon de tokenuri revizuit, înainte de activare.
...
| Organizator extensibil din plasă pentru sertarul biroului | Amazon rang 6 (`B0CCDJQ7MM`), listare explicită „Marbrasse”; documentul local `artifacts/amazon-pilot-crossmarket-2026-09-24.json` are o listare eBay asemănătoare, fără dovada unui furnizor comun. La revizia din 26 septembrie, [listarea Amazon](https://www.amazon.com/dp/B0CCDJQ7MM) a declarat și un brevet de design `D1093043` (afirmația vânzătorului, neverificată independent). | **Suspendat din pilotul generic.** Nu se caută o copie bazată pe această listare. Verificare IP separată sau înlocuirea conceptului; dimensiunile RFQ diferă de produsul sursă. |
