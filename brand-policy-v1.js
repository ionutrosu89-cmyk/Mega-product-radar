...
export const ESTABLISHED_BRAND_PHRASES=Object.freeze([
  'adidas','amazon basics','amazon essentials','amazonbasics','avery','barbie','belkin','black decker','bosch','brother','camco','canon','catit','closetmaid','crayola','cricut','delta children','dewalt','dremel','ecotools','felco','fisher price','fiskars','gaiam','gearit','gerber','hasbro','herschel','honey can do','honeywell','iris usa','jansport','kensington','kidkraft','learning resources','lego','litter genie','liquitex','logitech','makita','marvel','mattel','melissa doug','milwaukee','munchkin','nerf dog','new balance','nike','north face','osprey','park tool','petmate','petsafe','philips','pilot','puma','rain design','rawlings','reebok','rotring','rubbermaid','samsonite','samsung','sanus','sharpie','skechers','skip hop','smith','sony','stanley','steelseries','swingline','targus','travelpro','triggerpoint','tumi','ugreen','valeo','vtech','wagner','wall control','whitmor'
]);
