...
const files=['index.html','login.html','account.html','executive-ro.html','supplier-intelligence.html','review-intelligence-v2.html','action-center.html','validation-workflow-v2.html','radar-ro.html','discovery-inbox.html','organic-rising.html','market-intelligence.html','watchlist.html','alerts.html','validation-queue.html','data-confidence.html','strict-audit-ro.html','todays-opportunities.html','fresh-finds.html','purchase-manager-ro.html','landed-cost.html','data-vault.html'];
...
const report={version:'9.2-validation-workflow-v2',checkedAt:new Date().toISOString(),deviceTarget:'Web/iPhone/Android PWA static readiness',pagesSource:'GitHub Pages main:/',physicalDeviceTest:false,results};
