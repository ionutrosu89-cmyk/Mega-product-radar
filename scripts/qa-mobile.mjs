...
const files=['index.html','login.html','account.html','executive-ro.html','supplier-intelligence.html','review-intelligence-v2.html','action-center.html','validation-workflow-v2.html','product-decision.html','free-readiness.html','radar-ro.html','discovery-inbox.html','organic-rising.html','market-intelligence.html','watchlist.html','alerts.html','validation-queue.html','data-confidence.html','strict-audit-ro.html','todays-opportunities.html','fresh-finds.html','purchase-manager-ro.html','landed-cost.html','data-vault.html','golden-pipeline.html','commercial-validation.html'];
const premium=await fs.readFile(path.join(root,'premium-ui.css'),'utf8');
const freeJourneyPages=['home.html','discover.html','top25.html','onboarding.html','beta-study.html','beta-feedback.html'];
...
const results=[];
for(const file of [...new Set([...files,...freeJourneyPages])]){
...
const report={version:'10.1-golden-commercial',checkedAt:new Date().toISOString(),deviceTarget:'Web/iPhone/Android PWA static readiness',pagesSource:'Netlify source pages; published bundle: _site',physicalDeviceTest:false,results};
