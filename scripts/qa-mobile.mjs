...
const report={version:'9.1-action-supplier-review-v2',checkedAt:new Date().toISOString(),deviceTarget:'Web/iPhone/Android PWA static readiness',pagesSource:'GitHub Pages main:/',physicalDeviceTest:false,results};
