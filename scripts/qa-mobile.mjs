...
const files=['index.html','login.html','account.html','executive-ro.html','supplier-intelligence.html','radar-ro.html','discovery-inbox.html','strict-audit-ro.html','todays-opportunities.html','fresh-finds.html','purchase-manager-ro.html','landed-cost.html','data-vault.html'];
...
const report={version:'7.1-ro',checkedAt:new Date().toISOString(),deviceTarget:'Web/iPhone/Android PWA static readiness',pagesSource:'GitHub Pages main:/',physicalDeviceTest:false,results};
