...
for(const required of ['commercial-watchlist-page.js','commercial-watchlist.js','commercial-decision-client.js','commercial-decision-engine.js','profit-engine-v2.js','supplier-quote-verifier.js','supplier-negotiation-engine.js','rfq-economics-envelope.js','customer-ui.css','customer-shell.js','academy.html','academy.js'])await fs.access(path.join(out,required));
