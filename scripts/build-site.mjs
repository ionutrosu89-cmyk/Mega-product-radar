...
for(const file of[
  ...
  'purchase-manager.html','purchase-manager.js','landed-cost.html','landed-cost.js','landed-cost-evidence.js','market-profiles-v1.js','freight-chargeable-v1.js','carrier-profiles-v1.js','freight-comparison-v1.js','quantity-economics-v1.js','commercial-score-v1.js','discovery-inbox.html','discovery-inbox.js','discovery-engine.js','discovery-live.json','organic-rising-live.json','discovery-history.json','discovery-history.js','review-intelligence.js','data-vault.html','data-vault.js',
...
for(const required of['commercial-watchlist-page.js','commercial-watchlist.js','commercial-decision-client.js','commercial-decision-engine.js','profit-engine-v2.js','opportunity-v5.js','opportunity-ux-v1.js','supplier-quote-verifier.js','supplier-negotiation-engine.js','rfq-economics-envelope.js','landed-cost-evidence.js','market-profiles-v1.js','freight-chargeable-v1.js','carrier-profiles-v1.js','freight-comparison-v1.js','quantity-economics-v1.js','commercial-score-v1.js','sourcing-ops.html','sourcing-ops.js','rfq-dispatch-state.js','test-execution.html','test-execution.js','test-execution-engine.js','test-execution-client.js','customer-ui.css','customer-navigation-access.js','customer-shell.js','academy.html','academy.js','plan-recommendation-v1.js','executive-ro.html','executive-dashboard.js','portfolio-store.js','feedback-store.js','domain-contracts-v1.js'])await fs.access(path.join(out,required));
