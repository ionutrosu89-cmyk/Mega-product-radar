...
for(const file of[
  ...
  'saas-config.js','supabase-client.js','workspace-client.js','cloud-sync.js','billing-plans.js','billing-client.js','saas-shell.js','commercial-access.js','commercial-decision-client.js','commercial-decision-engine.js','profit-engine-v2.js','product-ro.js','opportunity-v5.js','opportunity-ux-v1.js','premium-ui.css','contrast-fix.css','customer-ui.css','customer-shell.js','login.html','login.js','account.html','account.js',
