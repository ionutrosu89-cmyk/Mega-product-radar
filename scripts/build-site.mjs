...
for(const required of ['commercial-watchlist-page.js','commercial-watchlist.js','commercial-decision-client.js','commercial-decision-engine.js','profit-engine-v2.js','supplier-quote-verifier.js','supplier-negotiation-engine.js','rfq-economics-envelope.js','landed-cost-evidence.js','sourcing-ops.html','sourcing-ops.js','rfq-dispatch-state.js','test-execution.html','test-execution.js','test-execution-engine.js','test-execution-client.js','supplier-rfq-dispatch/car-sunglasses-magnetic-visor-holder.json','supplier-candidates/car-sunglasses-magnetic-visor-holder.json','docs/rfq-car-sunglasses-magnetic-visor-holder.md','customer-ui.css','customer-shell.js','academy.html','academy.js'])await fs.access(path.join(out,required));
