...
for(const file of[
  ...
  'purchase-manager.html','purchase-manager.js','landed-cost.html','landed-cost.js','landed-cost-evidence.js','quantity-optimizer.html','quantity-optimizer.js','market-profiles-v1.js','freight-chargeable-v1.js','carrier-profiles-v1.js','carrier-freight-evidence-v1.js','freight-comparison-v1.js','quantity-economics-v1.js','commercial-score-v1.js','discovery-inbox.html','discovery-inbox.js','discovery-engine.js','discovery-live.json','organic-rising-live.json','discovery-history.json','discovery-history.js','review-intelligence.js','data-vault.html','data-vault.js',
