...
export function analyzeEconomicsV3({canonicalProductId=null,supplierQuote=null,costEvidence={},sellPrice=null,scenarioAssumptions={},targets={}}={}){
  ...
  // The quote proves supplier provenance/identity, but it is not silently copied into
  // the canonical cost ledger. Economics requires an explicit supplierUnitCost evidence row.
  ...
  return Object.freeze({
    ...
    policy:'CANONICAL_SUPPLIER_QUOTE_MATCH_REQUIRED; EXPLICIT_SUPPLIER_UNIT_COST_EVIDENCE_REQUIRED; ALL_CRITICAL_COSTS_REQUIRE_STRONG_EVIDENCE; UNKNOWN_COSTS_STAY_UNKNOWN; BEST_BASE_WORST_EXPLICIT; BREAK_EVEN_IS_DERIVED_NOT_VERIFIED_SALES; ECONOMICS_NEVER_AUTHORIZES_PURCHASE'
  });
}
