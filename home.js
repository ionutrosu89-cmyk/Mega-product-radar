...
load().catch(error=>{document.body.innerHTML=`<main style="padding:24px;font-family:sans-serif"><b>Dashboard indisponibil momentan.</b><p>${esc(error?.message||error)}</p><a href="home.html">Încearcă din nou</a></main>`;});
