export const SAAS_PLANS=Object.freeze({
  FREE:{
    ...
    features:['DISCOVERY','CATEGORY_UNIVERSE','TOP_PRODUCTS','SELLER_BRAND_INTELLIGENCE','MARKET_HISTORY_BASIC']
  },
  DISCOVER:{
    code:'DISCOVER',name:'Discover',monthlyPriceEur:17.9,scanCredits:100,workspaces:1,teamSeats:1,
    features:['DISCOVERY','CATEGORY_UNIVERSE','TOP_PRODUCTS','SELLER_BRAND_INTELLIGENCE','MARKET_HISTORY_BASIC','SUPPLIERS','SUPPLIER_BENCHMARK','LANDED_COST','PROFIT','IMPORT_RISK','ECONOMICS']
  },
  RADAR:{
    code:'RADAR',name:'Radar',monthlyPriceEur:29,scanCredits:300,workspaces:1,teamSeats:1,
    features:['DISCOVERY','CATEGORY_UNIVERSE','TOP_PRODUCTS','SELLER_BRAND_INTELLIGENCE','MARKET_HISTORY_BASIC','SUPPLIERS','SUPPLIER_BENCHMARK','LANDED_COST','PROFIT','IMPORT_RISK','ECONOMICS','RADAR','TRENDING','RISING','HISTORY','FILTERS','ALERTS','ROMANIA_GAP','OPPORTUNITY_ENGINE','DECISION_GATE','WATCHLIST']
  },
  LAUNCH:{
