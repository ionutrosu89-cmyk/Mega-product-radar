...
| P1 | Google | Keyword Planner (semnal de cerere), conform eligibilității și termenilor | 0 € | Verificarea accesului contului și a permisiunilor de utilizare în produsul SaaS |
...
Snapshot-urile curente folosesc tabelul `current_top25_snapshots_v1`. Arhiva nu mai are cititor sau colector public. Colectorul scrie mai întâi în zona internă; API-ul public validează apoi numărul de produse, prospețimea, URL-urile și tipul dovezii. Orice eșec produce listă indisponibilă, nu fallback inventat.
