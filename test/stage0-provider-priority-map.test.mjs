...
test('Stage 0 maps dedicated deep priority into isolated provider rank and restores Golden rank',async()=>{
  const source=await fs.readFile('scripts/provider-intelligence-stage0.mjs','utf8');
  assert.match(source,/stage0_deep_marketplace_targets/);
