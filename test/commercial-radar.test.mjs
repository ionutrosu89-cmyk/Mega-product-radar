...
test('Discover plan cannot access protected commercial Radar payload',async()=>{
  ...
  assert.equal(response.status,403);const body=await response.json();assert.equal(body.plan,'DISCOVER');
});
