...
test("only the canonical Netlify Functions are present", async () => {
  ...
  assert.deepEqual(entries, ["commercial-discover.mjs","radar-data.mjs","radar-health.mjs","radar-scan-background.mjs","radar-schedule.mjs","radar-sync.mjs","radar-trigger.mjs"]);
});
