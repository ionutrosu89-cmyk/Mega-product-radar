...
test("only the canonical Netlify Functions are present", async () => {
  ...
  assert.deepEqual(entries, ["beta-analytics.mjs","billing-cancel.mjs","billing-change-plan.mjs","billing-checkout.mjs","billing-readiness.mjs","billing-status.mjs","billing-webhook.mjs","commercial-discover.mjs","commercial-radar.mjs","radar-data.mjs","radar-health.mjs","radar-scan-background.mjs","radar-schedule.mjs","radar-sync.mjs","radar-trigger.mjs"]);
});
